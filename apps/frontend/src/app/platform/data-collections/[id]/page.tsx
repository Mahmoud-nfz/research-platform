...
import { ChevronLeftDouble, CloudUploadIcon,BigUploadCloudIcon} from "@/assets";
  ...
  return (
    <div className="flex flex-col p-5 flex-grow justify-between h-full">
      ...
      <div className="flex flex-row">
        <UploadModal buttonPrompt="Televerser des donnees" buttonIcon={<CloudUploadIcon/>} buttonClassName="bg-primary-300" uploadIcon={<BigUploadCloudIcon/>}/>
      </div>
    </div>
  );
}
